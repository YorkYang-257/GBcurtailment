...
def read_model(model_data):
    ...
    for l in data.splitlines():
        ...
        if READ is True:
            g, pg, status, ITO_g, ITF_g, min_g, max_g, min_up_time, min_down_time, ramp_up_rate, ramp_down_rate, startup_ramp_rate, shutdown_ramp_rate, coldstartcost, hotstartcost, shutdowncostcoefficient = l.split()
            ...
            c.gen.loc[g, 'InitialTimeON'] = int(ITO_g)
            c.gen.loc[g, 'InitialTimeOFF'] = int(ITF_g)
